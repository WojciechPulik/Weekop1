...
public class VoteDAOImpl implements VoteDAO{
	...
	private static final String READ_VOTE_BY_DISCOVERY_USE_ID = "SELECT vote_id, discovery_id, user_id, date, type "
	...
	public Vote getVoteByUserIdDiscoveryId(long userId, long discoveryId) {
		...
		Vote vote = null;
		try {
			vote = template.queryForObject(READ_VOTE_BY_DISCOVERY_USE_ID, paramSource, new VoteRowMapper());
